            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="${formUrl}" method="post" enctype="multipart/form-data" id="formEdit">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"><fmt:message
                                    key="label.garamarguideline.upload.image" bundle="${lang}"/></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"><fmt:message
                                    key="label.garamarguideline.upload.image.view" bundle="${lang}"/></label>
                            <div class="col-sm-9">
                                <c:if test="${not empty item.pojo.image}">
                                    <c:set var="image" value="/fileupload/listenguideline/${item.pojo.image}"/>
                                </c:if>
                                <img src="${image}" id="viewImage" width="320px" height="180px"/>
                            </div>
                        </div>
                        <br/>
                        <br/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"><fmt:message
                                    key="label.guideline.listen.content" bundle="${lang}"/></label>
                            <div class="col-sm-12">
